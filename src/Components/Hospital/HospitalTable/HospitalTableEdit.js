...
const HospitalTableEdit = ({ initialHospitalValue }) => {
    const [open, setOpen] = useState(false);
    const [confirm, setConform] = useState(false);
    const [isEditing, setIsEditing] = useState(false);
    const [name, setName] = useState(initialHospitalValue.data.name);
    const [address, setAddress] = useState(initialHospitalValue.data.address);
    const [pincode, setPincode] = useState(initialHospitalValue.data.pincode);
        ...
        <>
            ...
            >
                ...
                <Dialog open={confirm} onClose={handleClose}>
                    ...
                    <DialogContent>
                        <DialogContentText>
                            Conform Delete {name} Hospital Inforamation?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
...
export default HospitalTableEdit;
